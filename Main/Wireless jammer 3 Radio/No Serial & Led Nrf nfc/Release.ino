...
void SAtk() {
  ...
  if (radio3.begin(&vspi)) {
    ...
    digitalWrite(Led_pin, HIGH);
    digitalWrite(Led_NNfc3, HIGH);
    delay(100);
    digitalWrite(Led_pin, LOW);
    delay(100);}}
void setup() {
  pinMode(Led_pin, OUTPUT);
  pinMode(Led_NNfc1, OUTPUT);
  pinMode(Led_NNfc2, OUTPUT);
  pinMode(Led_NNfc3, OUTPUT);
  SAtk();}
void loop() {
